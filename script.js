        ...
        $(".art-hmenu>li").each(function(i, v) {
            ...
            if (subm.length > 0) {
                ...
                if (style !== null && typeof style.insertRule !== "undefined") {
                    ...
                    var rule = "clip: rect(12px, " + Math.round(parseFloat(r, 10)) + "px, " + Math.round(parseFloat(b, 10)) + "px, -" + shadow + "px);";
                    itm.addClass(cls);
...
var ThemeLightbox = (function ($) {
    ...
    return (function () {
        ...
        function showError(enable) {
            if (enable) {
                $(".art-lightbox-wrapper").append($('<div class="lightbox-error">Begärt innehåll kunde inte laddas.<br/>Vänligen försök igen senare.</div>')
